...
func EsnserverScan(address string, client *http.Client, Red string, Green string, Yellow string, Reset string, Cyan string, currentTime string) {
	Portalreadfile := "用友 U8cloud esnserver 远程代码执行漏洞"
	urls := address + "/service/esnserver"
