...
func Link_contentScan(address string, client *http.Client, Red string, Green string, Yellow string, Reset string, Cyan string, currentTime string) {
	Portalreadfile := "用友 NC content SQL注入漏洞"
	urls := address + "/portal/pt/link/content?pageId=login&pk_funnode=1"
